...
namespace Thesis.Visualization
{
    ...
    {
        //--- Public Variables ---//
        [Header("File Override")]
        public bool overrideFileLocations = false;
        [Header("Static Data File Override")]
        public string staticDataFolder;
        [Tooltip("file name without extension")]
        public string staticDataFileName = "StaticData";
        [Header("Dynamic Data File Override")]
        public string dynamicDataFolder;
        [Tooltip("file name without extension")]
        public string dynamicDataFileName = "DyanmicData";

        [Space]
        [Header("Visualziation")]
        ...
        private void Reset()
        {
            ...
            staticDataFolder = folderPath;
            dynamicDataFolder = folderPath;
        }
        ...
        public bool LoadStaticData(string _staticFilePath)
        {
            ...
            string filePath = _staticFilePath;
            if (overrideFileLocations)
            {
                filePath = staticDataFolder + "\\" + staticDataFileName + ".log";
            }
            ...
            string staticData = FileIO_FileReader.ReadFile(filePath);
        ...
        public bool LoadDynamicData(string _dynamicFilePath)
        {
            ...
            string filePath = _dynamicFilePath;
            if (overrideFileLocations)
            {
                filePath = dynamicDataFolder + "\\" + dynamicDataFileName + ".log";
            }
            ...
            string dynamicData = FileIO_FileReader.ReadFile(filePath);
